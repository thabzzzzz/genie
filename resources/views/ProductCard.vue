<template>
  <div v-if="games && games.results && games.results.length">
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-10">
      <div v-for="game in games.results" :key="game.id" class="card border border-black mx-auto product-card" style="width: 21rem;">
